    ...
    <div class="page-main">
        ...
        <div class="main-content">
            ...
            <section class="diet-plan">
                ...
                <div class="info-box">
                    <h3>등록된 사용자 지정 식단</h3>
                    <form action="${pageContext.request.contextPath}/mydiet/registerCustomDietRequestForm.do" method="post">
                ...
                <!-- 선택된 식단 데이터를 조회만 하도록 변경 -->
                <c:if test="${not empty selectedDietPlan}">
                    <div class="info-box">
                        <!-- 식단 정보 표시 -->
                        <div class="info-item">
                            <label class="label">음식 이름:</label>
                            <span>${selectedDietPlan.foodName}</span>
                        </div>

                        <div class="info-item">
                            <label class="label">칼로리(kcal):</label>
                            <span>${selectedDietPlan.calories}</span>
                        </div>

                        <div class="info-item">
                            <label class="label">단백질(g):</label>
                            <span>${selectedDietPlan.protein}</span>
                        </div>

                        <div class="info-item">
                            <label class="label">탄수화물(g):</label>
                            <span>${selectedDietPlan.carbohydrate}</span>
                        </div>

                        <div class="info-item">
                            <label class="label">지방(g):</label>
                            <span>${selectedDietPlan.fat}</span>
                        </div>

                        <div class="info-item">
                            <label class="label">미네랄(mg):</label>
                            <span>${selectedDietPlan.minerals}</span>
                        </div>
