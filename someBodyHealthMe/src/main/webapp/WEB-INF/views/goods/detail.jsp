						...
						<ul>
							...
							<c:if test="${goods.goods_quantity > 0}">
								...
								<ul class="detail-sub">
									...
									<li><input type="button" id="buygoods" value="구매하기" disabled></li>
								</ul>
								<ul>
									<li class="cart-ask-btn">
									<input type="button" id="cartgoods" value="장바구니에 담기" disabled>
				...
				<div id="reply_div">
					<form id="re_form">
						...
						<div class="rating-value">
							<label>
					        <img src="${pageContext.request.contextPath}/images/emptystar.png" class="star" data-rating="1" id="star1">
						    </label>
						    <label>
					        <img src="${pageContext.request.contextPath}/images/emptystar.png" class="star" data-rating="2" id="star2">
						    </label>
						    <label>
					        <img src="${pageContext.request.contextPath}/images/emptystar.png" class="star" data-rating="3" id="star3">
						    </label>
						    <label>
					        <img src="${pageContext.request.contextPath}/images/emptystar.png" class="star" data-rating="4" id="star4">
						    </label>
						    <label>
					        <img src="${pageContext.request.contextPath}/images/emptystar.png" class="star" data-rating="5" id="star5">
					    	</label>
						</div>
