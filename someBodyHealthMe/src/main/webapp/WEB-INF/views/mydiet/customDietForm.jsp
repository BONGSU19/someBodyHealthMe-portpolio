		...
		<div class="main-content">
			...
			<section class="diet-plan">
				...
				<form
					...
					<div class="info-box">
						<div class="form-item">
							<label for="foodName" class="label">식품 이름</label> <input
						...
						<div class="form-item">
							<label for="calories" class="label">칼로리(kcal)</label> <input
						...
						<div class="form-item">
							<label for="protein" class="label">단백질(g)</label> <input
						...
						<div class="form-item">
							<label for="carbohydrate" class="label">탄수화물(g)</label> <input
						...
						<div class="form-item">
							<label for="fat" class="label">지방(g)</label> <input type="text"
						...
						<div class="form-item">
							<label for="minerals" class="label">미네랄(g)</label> <input
