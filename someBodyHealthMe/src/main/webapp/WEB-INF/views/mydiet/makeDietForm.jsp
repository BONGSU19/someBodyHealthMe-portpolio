        ...
        <div class="main-content-nutrition">
            ...
            <div class="meal-records">
                <div class="meal-box" id="breakfast">
                    ...
                    <button class="add-button" onclick="location.href='${pageContext.request.contextPath}/mydiet/noteDietForm.do'">+</button>
                </div>
            ...
            <div class="nutrition-info">
                ...
                <div class="nutrition-box">
                    <p>칼로리: <span id="total-calories">2000 kcal</span></p>
                    <div class="gauge">
